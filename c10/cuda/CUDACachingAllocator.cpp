...
class DeviceCachingAllocator {
 private:
  ...
  CCARingBuffer<TraceEntry> alloc_buffer;
...
class NativeCachingAllocator : public CUDAAllocator {
 private:
  ...
  bool record_history = false;
  CCARingBuffer<AnnotationEntry> annotation_buffer;
 ...
 public:
  ...
  SnapshotInfo snapshot() override {
    ...
    annotation_buffer.getEntries(result.user_defined);
    for (auto& ae : result.user_defined) {
